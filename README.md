...
For now this package supports only <b>[Independent](https://lerna.js.org/docs/api-reference/configuration#version)</b> versioning mode, synced mode is planned to be added soon.
